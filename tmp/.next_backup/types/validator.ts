...
// Validate ../../app/blog/strategy-that-ships/page.tsx
{
  const handler = {} as typeof import("../../app/blog/strategy-that-ships/page.js")
  handler satisfies AppPageConfig<"/blog/strategy-that-ships">
}
...
// Validate ../../app/api/git-content/route.ts
{
  const handler = {} as typeof import("../../app/api/git-content/route.js")
  handler satisfies RouteHandlerConfig<"/api/git-content">
}
