...
import { Shield, Users, Zap, Building2, TrendingUp, Target, Link as LinkIcon, Database } from 'lucide-react'
                        ...
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-24 w-56 items-center">
                                    ...
                                    <span className="mx-auto block w-fit text-5xl font-semibold">8</span>
                                </div>
                                <h2 className="mt-6 text-center text-3xl font-semibold">Weeks</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border-border border before:absolute before:-inset-2 before:rounded-full before:border-border before:border">
                                    <Zap className="m-auto h-fit w-24 text-primary" strokeWidth={1} />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition text-foreground">Quick Wins Start Week One</h2>
                                    <p className="text-foreground">We start executing week one, not month three. While building your strategic foundation, you'll see immediate improvements that impact your pipeline before the sprint ends.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <svg className="dark:text-muted-foreground w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g clipPath="url(#clip0_0_106)">
                                            ...
                                            <path d="M29 23V35" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-card-foreground" />
                                            <path d="M35 29L29 35L23 29" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-card-foreground" />
                                            <path
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition">Strategy Connected to Revenue</h2>
                                    <p className="text-foreground">Most marketing roadmaps prioritize busy work over revenue. We connect every initiative directly to revenue: what generates pipeline, what converts prospects, what drives growth you can measure.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border-border border before:absolute before:-inset-2 before:rounded-full before:border-border before:border">
                                        <Building2 className="m-auto size-5" strokeWidth={1} />
                                    </div>
                                ...
                                <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6">
                                    <div className="absolute left-3 top-2 flex gap-1">
                                        <span className="block size-2 rounded-full border-border border bg-muted"></span>
                                        <span className="block size-2 rounded-full border-border border bg-muted"></span>
                                        <span className="block size-2 rounded-full border-border border bg-muted"></span>
                                    </div>
                                ...
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Strategy</span>
                                            <div className="ring-background size-7 ring-4">
                                                <Target className="size-full p-1 text-primary" />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-background size-8 ring-4">
                                                <Database className="size-full p-1 text-primary" />
                                            </div>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Data</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Systems</span>
                                            <div className="ring-background size-7 ring-4">
                                                <Building2 className="size-full p-1 text-primary" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
