...
seo:
  ...
  description: "Growth plateaued? Before hiring a fractional CMO, agency, or consultant, ask these 8 diagnostic questions. Find out what you actually need (not what someone's selling)."
  keywords:
    - "growth stalled"
...
2. Identify patterns in your best customers
3. Build a defensible ICP framework
4. Test and validate the positioning
...
**What you need first**:
1. Unified analytics dashboard (GA4 → CRM → revenue)
2. Attribution model (even a simple one)
3. Baseline metrics from past 6-12 months
...
### For Fractional CMOs:
1. "What happens to the strategy and systems when you leave?"
2. "How will you transfer knowledge to my team?"
3. "What does ownership transfer look like?"
4. "Do you work on strategic architecture or just ongoing optimization?"

### For Strategy Consultants:
1. "What exactly will I own at the end?"
2. "How will you train my team to use what you build?"
3. "What ongoing access do I have to dashboards and systems?"
4. "Do you just deliver strategy docs, or do you build executable systems?"

### For Agencies:
1. "What happens if we need to bring this in-house in 12 months?"
2. "Can we see the actual campaign data and systems?"
3. "Who owns the creative assets and frameworks you build?"
4. "How dependent will we be on you for ongoing execution?"

---

## Free Tool: Complete 15-Question Growth Diagnostic

These 8 questions are the core diagnostic—but there are 7 more that help you get even more specific about what type of help you need.

📋 **[Download the Complete Growth Diagnostic →](/lead-magnets/growth-diagnostic)**

It's a Google Doc with:
- 15 scored questions across 5 categories
- Automated recommendations based on your score
- Honest "what you DON'T need" guidance
- Direct links to next steps

Takes 10 minutes. Might save you $50K and 6 months.

---

## Real Cost Comparison: Getting This Wrong vs. Getting It Right
...
→ [See our 8-week strategy sprint process](/process)
...
We'll ask you these 8 questions, tell you exactly what type of help you need—even if that's not us.
